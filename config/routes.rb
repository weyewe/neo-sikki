NeoSikki::Application.routes.draw do
  ...
  namespace :api2 , constraints: { format: 'json' } do
    ...
    get 'members/alianz_deceased_members' => 'members#alianz_deceased_members', :as => :get_alianz_deceased_members
  ...
  namespace :api do
    ...
    get 'search_app_user' => 'app_users#search', :as => :search_app_user
