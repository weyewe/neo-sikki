...
describe GroupLoanWeeklyCollectionAttendance do
    ...
    context "create group loan membership" do
      ...
      context "starting the group_loan" do
        ...
        context "execute loan disbursement" do
          ...
          it "should have created group loan weekly_collection attendances" do

          	total_collection = @group_loan.group_loan_weekly_collections.count
          	total_member = @group_loan.group_loan_memberships.count
          	total_glwc_a = total_collection * total_member
          	weekly_collection_id_array = [] 
          	@group_loan.group_loan_weekly_collections.each {|x| weekly_collection_id_array << x.id }

          	GroupLoanWeeklyCollectionAttendance.where(
          		:group_loan_weekly_collection_id => weekly_collection_id_array
          		).count.should ==  total_glwc_a
          end
          ...
          context "undisburse group loan " do
          	...
          	it "should have no attendance" do
          		GroupLoanWeeklyCollectionAttendance.count.should == 0
          	end
          end
