...
describe GroupLoan do
  ...
  context "a member  run away ( week 2 ) "  do
    ...
    it "should create transaction to reduce bad debt allocation in week 2 since there is weekly payment"
    ...
    context "creating collection and confirm for week 3" do
      ...
      it "should create transaction to reduce bad debt allowance since there is weekly payment"
